    ...
    @else
        <style>
            ...
            @layer theme {
                ...
                :root,
                :host {
                    --font-inter: 'Instrument Sans', ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
                    ...
                    --default-font-feature-settings: var(--font-inter--font-feature-settings);
                    --default-font-variation-settings: var(--font-inter--font-variation-settings);
...
<body
    ...
    @if (Route::has('login'))
        <nav class="flex items-center justify-end gap-4">
            ...
            {{-- If logged in, also show Dashboard + Logout --}}
            @auth
